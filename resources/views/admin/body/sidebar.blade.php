...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            $material  = (auth()->guard('admin')->user()->material == 1);
            @endphp
            ...
            <li class="treeview {{ ($prefix == '/material')?'active':'' }}  ">
                <a href="#">
                    <i class="fa fa-th-list"></i>
                    <span>Bahan</span>
                    <span class="pull-right-container">
                ...
                <ul class="treeview-menu">
                    <li class="{{ ($route == 'units.index') ? 'active':'' }}"><a href="{{ route('units.index') }}"><i class="ti-more"></i>Satuan Bahan</a></li>
                    <li class="{{ ($route == 'materials.index') ? 'active':'' }}"><a href="{{ route('materials.index') }}"><i class="ti-more"></i>Kelola Bahan</a></li>
                    <li class="{{ ($route == 'material_in.index') ? 'active':'' }}"><a href="{{ route('material_in.index') }}"><i class="ti-more"></i>Stok Masuk (Re-Stok)</a></li>
                    <li class="{{ ($route == 'material_out.index') ? 'active':'' }}"><a href="{{ route('material_out.index') }}"><i class="ti-more"></i>Stok Keluar</a></li>
                </ul>
            </li>
