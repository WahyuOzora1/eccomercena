...
<body class="cnt-home">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input hidden id="stock"  >

                            <button type="submit" id="submitCartModal" class="btn btn-primary mb-2" onclick="addToCart()">Keranjang</button>
    ...
    <script type="text/javascript">
        ...
        function productView(id) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#product_id').val(id);
                    $('#qty').val(1);
                    $('#stock').val(data.product.product_qty);
                    ...
                    if (data.product.product_qty > 0) {
                        ...
                        document.getElementById("submitCartModal").disabled = false;
                    } else {
                        $('#aviable').text('');
                        $('#stockout').text('');
                        $('#stockout').text('tidak tersedia');
                        document.getElementById("submitCartModal").disabled = true;
                    } // end Stock Option 
        ...
        //Validasi Jumlah Pembelian dan Stok Barang
