...
use App\Http\Controllers\Admin\MaterialInController;
use App\Http\Controllers\Backend\CategoryController;
use App\Http\Controllers\Admin\MaterialOutController;
...
Route::middleware(['auth:admin'])->prefix('product')->group(function () {
    ...
    Route::resource('manage.product_material', ProductMaterialController::class)->shallow();

    Route::get('/delete_pm/{id}', [ProductMaterialController::class, 'delete'])->name('product_material.delete');
});
...
Route::middleware(['auth:admin'])->prefix('material')->group(function () {
    Route::resource('units', UnitController::class);
    Route::get('units/delete/{id}', [UnitController::class, 'delete'])->name('units.delete');

    Route::resource('materials', MaterialController::class);
    Route::get('materials/delete/{id}', [MaterialController::class, 'delete'])->name('materials.delete');

    Route::resource('material_in', MaterialInController::class);
    Route::get('material_in/delete/{id}', [MaterialInController::class, 'delete'])->name('material_in.delete');

    Route::resource('material_out', MaterialOutController::class);
    Route::get('material_out/delete/{id}', [MaterialOutController::class, 'delete'])->name('material_out.delete');
});
