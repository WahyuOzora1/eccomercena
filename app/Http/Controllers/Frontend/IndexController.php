...
class IndexController extends Controller
{
	...
	{
		$recentlyViewedProducts = DB::table('recently_viewed_products')
	...
	public function ProductDetails($id, $slug)
	{
		...
		$compositionProducts = DB::table('products')
			->join('compositions', 'compositions.id_product', '=', 'products.id')
			->select('compositions.id', 'compositions.name', 'compositions.price')
			->get();
