            ...
            if (division_id) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('select[name="district_id"]').append('<option value="" disabled selected>-- Pilih Kabupaten --</option>');
            ...
            if (district_id) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('select[name="state_id"]').append('<option value="" disabled selected>-- Pilih Kecamatan --</option>');
                        $.each(data, function (key, value) {
